...
def test(
    ...
    nC = 80 #int(data_config['classes'])  # number of classes (80 for COCO)
    #test_path = data_config['valid']
    test_path = "/content/drive/My Drive/pic_paths_with_boxes2.txt"
    # Initiate model
    ...
    dataloader = load_images_and_labels(test_path, batch_size=batch_size, img_size=img_size, test=True)
