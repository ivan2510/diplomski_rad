...
def train(
    ...
    num_classes = 80
    train_path = "/content/drive/My Drive/pic_paths.txt"
    ...
    if resume:
        ...
        def_weight_file = "/content/drive/My Drive/yolov3-tiny.weights" #os.path.join(weights_path, DARKNET_WEIGHTS_FILENAME)
...
if __name__ == '__main__':
    ...
    train(
        "/content/drive/My Drive/yolov3-tiny.cfg",
        None,
        img_size=(608,608),
        img_size_test=(608,608),
        resume=False,
